...
class UnknownPlugin extends plugin_1.SkyWayPlugin {
    constructor() {
        ...
        this._createRemoteMember = (channel, memberDto) => {
            const person = new member_1.UnknownMemberImpl(Object.assign(Object.assign({}, this._context), { channel, metadata: memberDto.metadata, id: memberDto.id, name: memberDto.name, plugin: this, subtype: memberDto.subtype }));
            return person;
        };
    }
}
