...
class PersonPlugin extends plugin_1.SkyWayPlugin {
    constructor() {
        ...
        this._whenCreateLocalPerson = (person) => __awaiter(this, void 0, void 0, function* () {
            this.messageBuffers[person.id] = new messageBuffer_1.MessageBuffer(person._messaging);
        });
        ...
        this._createRemoteMember = (channel, memberDto) => {
            const person = new member_1.RemotePersonImpl(Object.assign(Object.assign({}, this._context), { channel, metadata: memberDto.metadata, id: memberDto.id, name: memberDto.name, plugin: this }));
            return person;
        };
    }
}
