...
// src/api.ts
var log3 = new Logger("packages/sfu-client/src/api.ts");
var SfuRestApiClient = class {
  constructor(_token, _options = {}) {
    ...
    log3.debug("SfuRestApiClient spawned", { endpoint: this.endpoint });
  }
  updateToken(token) {
    this._token = token;
  }
  createBot(_0) {
    return __async(this, arguments, function* ({
      ...
      const res = yield this.http.post("/bots", {
        appId,
        channelId
      }, { headers: { authorization: `Bearer ${this._token}` } }).catch((e) => {
        switch (e == null ? void 0 : e.status) {
          case 403:
            throw new SkyWayError({
              type: "insufficientPermissions",
              message: "createBot failed",
              payload: { data: e == null ? void 0 : e.data, status: e == null ? void 0 : e.status }
            });
          default:
            throw new SkyWayError({
              type: "backendError",
  ...
  startForwarding(_0) {
    return __async(this, arguments, function* ({
      ...
      if (backOff.retry > 0) {
        log3.warn("success to retry startForwarding", {
          botId,
          publicationId,
          retry: backOff.retry
        });
  ...
  createProducer(_0) {
    return __async(this, arguments, function* ({
      ...
      if (backOff.retry > 0) {
        log3.warn("success to retry createProducer", {
          botId,
          forwardingId,
          transportId,
          retry: backOff.retry
  ...
  createConsumer(_0) {
    return __async(this, arguments, function* ({
      ...
      if (backOff.retry > 0) {
        log3.warn("success to retry createConsumer", {
          botId,
          forwardingId,
          retry: backOff.retry
        });
  ...
  connect(_0) {
    return __async(this, arguments, function* ({
      ...
      if (backOff.retry > 0) {
        log3.warn("success to retry connect", {
          botId,
          forwardingId,
          transportId,
          retry: backOff.retry
  ...
  getCapabilities(_0) {
    return __async(this, arguments, function* ({
      ...
      if (backOff.retry > 0) {
        log3.warn("getCapabilities to retry connect", {
          botId,
          forwardingId,
          retry: backOff.retry
        });
