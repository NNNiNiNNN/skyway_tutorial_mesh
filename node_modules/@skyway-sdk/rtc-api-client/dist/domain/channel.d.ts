...
import { PublicationSummary, RtcRpcApiClient, SubscriptionSummary } from '@skyway-sdk/rtc-rpc-api-client';
import { MemberInit, PublicationInit, SkyWayApi, SubscriptionInit } from '..';
...
export declare class ChannelImpl implements model.Channel {
    ...
    readonly onMembershipChanged: import("@skyway-sdk/common").Event<event.MembershipChangedEvent>;
    ...
    readonly onPublicationChanged: import("@skyway-sdk/common").Event<event.PublicationChangedEvent>;
    ...
    readonly onSubscriptionChanged: import("@skyway-sdk/common").Event<event.SubscriptionChangedEvent>;
    readonly onStreamSubscribed: import("@skyway-sdk/common").Event<event.StreamSubscribedEvent>;
    readonly onStreamUnsubscribed: import("@skyway-sdk/common").Event<event.StreamUnsubscribedEvent>;
    constructor(appId: string, init: model.Channel, eventObserver: EventObserver, apiClient: SkyWayApi);
...
export declare function channelFactory(appId: string, rpc: RtcRpcApiClient, // todo refactor
api: SkyWayApi, // todo refactor
channelDto: Channel): ChannelImpl;
