  ...
  connect(_0) {
    return __async(this, arguments, function* ({
      ...
      const error = yield new Promise((r, f) => {
        ...
        this._ws.onerror = (e) => {
          log3.error("ws error before established", e);
          f(e);
        };
        this._ws.onopen = () => {
          clearTimeout(timeout);
      ...
      try {
        ...
        if (!this.reconnecting) {
          ...
          const message = yield Promise.race([
            this.onFatalError.asPromise(rpcTimeout + 100).then((e) => {
              if (!done) {
                log3.warn("[failed] reconnecting. pending request", { e });
              }
              throw e;
            }),
            handleMessage()
...
var SkyWayApiImpl = class {
  ...
  findOrCreateChannel(appId, query) {
    return __async(this, null, function* () {
      return this._client.findOrCreateChannel(__spreadProps(__spreadValues({}, query), { appId })).catch((e) => {
        const { payload } = e;
        switch (payload == null ? void 0 : payload.code) {
          case 4030:
            throw new SkyWayError({
  ...
  updateChannelMetadata(appId, id, metadata) {
    return __async(this, null, function* () {
      yield this._client.updateChannelMetadata({ appId, id, metadata }).catch((e) => {
        const { payload } = e;
        switch (payload == null ? void 0 : payload.code) {
          case 4030:
            throw new SkyWayError({
  ...
  unpublish(appId, channelId, publicationId) {
    return __async(this, null, function* () {
      yield this._client.unpublishStream({ channelId, publicationId, appId }).catch((e) => {
        const { payload } = e;
        switch (payload == null ? void 0 : payload.code) {
          case 4030:
            throw new SkyWayError({
...
var RtcApiClient = class {
  ...
  createChannel() {
    return __async(this, arguments, function* (init = {}) {
      ...
      const channelDto = yield this.apiClient.createChannel(this.appId, init).catch((e) => {
        log6.debug("[failed] apiClient.createChannel", { init, e });
        throw e;
      });
  ...
  findChannel(query) {
    return __async(this, null, function* () {
      ...
      const channelDto = yield this.apiClient.getChannel(this.appId, query).catch((e) => {
        log6.debug("[failed] apiClient.getChannel", { query, e });
        throw e;
      });
      const channel = channelFactory(this.appId, this._rpc, this.apiClient, channelDto);
  ...
  findOrCreateChannel(query) {
    return __async(this, null, function* () {
      ...
      const channelDto = yield this.apiClient.findOrCreateChannel(this.appId, query).catch((e) => {
        log6.debug("[failed] apiClient.findOrCreateChannel", { query, e });
        throw e;
      });
...
var ChannelImpl = class {
  constructor(appId, init, eventObserver, apiClient) {
    ...
    this.updateChannelMetadata = (metadata) => new Promise((r, f) => {
      ...
      this.onMetadataUpdated.watch((e) => e.channel.metadata === metadata).then(() => r()).catch((error) => f(new SkyWayError({
        type: "timeout",
    ...
    this.leave = (channelId, memberId) => new Promise((r, f) => {
      ...
      this.onMemberLeft.watch((e) => e.member.id === memberId, Config.get.rtcApi.timeout).then(() => r()).catch((error) => f(new SkyWayError({
        type: "timeout",
    ...
    this.updateMemberMetadata = (memberId, metadata) => new Promise((r, f) => {
      ...
      this.onMemberMetadataUpdated.watch((e) => e.member.id === memberId && e.member.metadata === metadata).then(() => r()).catch((error) => f(new SkyWayError({
        type: "timeout",
    ...
    this.unpublish = (publicationId) => new Promise((r, f) => {
      ...
      this.onStreamUnpublished.watch((e) => e.publication.id === publicationId).then(() => r()).catch((error) => f(new SkyWayError({
        type: "timeout",
    ...
    this.updatePublicationMetadata = (publicationId, metadata) => new Promise((r, f) => {
      ...
      this.onPublicationMetadataUpdated.watch((e) => e.publication.id === publicationId && e.publication.metadata === metadata).then(() => r()).catch((error) => f(new SkyWayError({
        type: "timeout",
    ...
    this.unsubscribe = (subscriptionId) => new Promise((r, f) => {
      ...
      this.onStreamUnsubscribed.watch((e) => e.subscription.id === subscriptionId).then(() => r()).catch((error) => f(new SkyWayError({
        type: "timeout",
  ...
  joinChannel(memberInit) {
    return __async(this, null, function* () {
      ...
      const member = (_a2 = this.getMember(res.id)) != null ? _a2 : (yield this.onMemberJoined.watch((e) => e.member.id === res.id, Config.get.rtcApi.timeout).catch((error) => {
        throw new SkyWayError({
          type: "timeout",
  ...
  publish(init) {
    return __async(this, null, function* () {
      ...
      const { publication } = yield this.onStreamPublished.watch((e) => e.publication.id === publicationDto.id, Config.get.rtcApi.timeout).catch((error) => {
        throw new SkyWayError({
          type: "timeout",
  ...
  subscribe(init) {
    return __async(this, null, function* () {
      ...
      const { subscription } = yield this.onStreamSubscribed.watch((e) => e.subscription.id === subscriptionDto.id, Config.get.rtcApi.timeout).catch((error) => {
        throw new SkyWayError({
          type: "timeout",
