...
class SfuRoomImpl extends base_2.RoomImpl {
    ...
    static Create(context, channel) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bot = channel.members.find((m) => m.subtype === sfu_client_1.SfuBotMember.subtype);
            if (!bot) {
    ...
    setChannelListener() {
        ...
        this._channel.onStreamSubscribed.add((e) => {
            this._handleOnStreamSubscribe(e.subscription);
        });
        this._channel.onStreamUnsubscribed.add((e) => this._handleOnStreamUnsubscribe(e.subscription));
    }
    ...
    _handleOnPublicationMetadataUpdate(publication) {
        const relayed = this.publications.find((p) => { var _a; return ((_a = p._publication.origin) === null || _a === void 0 ? void 0 : _a.id) === publication.id; });
        if (!relayed)
            return;
