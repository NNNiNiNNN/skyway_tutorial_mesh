...
export declare type ChannelEvent = ChannelCreatedEvent | ChannelDeletedEvent | ChannelMetadataUpdatedEvent | MemberAddedEvent | MemberRemovedEvent | MemberMetadataUpdatedEvent | StreamPublishedEvent | StreamUnpublishedEvent | PublicationMetadataUpdatedEvent | StreamSubscribedEvent | StreamUnsubscribedEvent;
export interface ChannelSummary {
    id: string;
    version: number;
    metadata: string;
}
export declare type PublicationSummary = Omit<Publication, 'codecCapabilities' | 'encodings' | 'channelId'>;
